...
We split both the original and shuffled networks into papers of each consituent field, then calculated the PageRank for all networks.
Finally, we create percentile scores by comparing the PageRanks for the original and shuffled networks, and make our results available at (TODO webserver URL).
