...
[![PDF Manuscript](https://img.shields.io/badge/manuscript-PDF-blue.svg)](https://greenelab.github.io/indices_manuscript/manuscript.pdf)
[![GitHub Actions Status](https://github.com/greenelab/indices_manuscript/workflows/Manubot/badge.svg)](https://github.com/greenelab/indices_manuscript/actions)
...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/greenelab/indices_manuscript/tree/gh-pages) and [`output`](https://github.com/greenelab/indices_manuscript/tree/output) branches.
The `gh-pages` branch uses [GitHub Pages](https://pages.github.com/) to host the following URLs:

+ **HTML manuscript** at https://greenelab.github.io/indices_manuscript/
+ **PDF manuscript** at https://greenelab.github.io/indices_manuscript/manuscript.pdf
...
Please attribute by linking to https://github.com/greenelab/indices_manuscript.
...
Please open [an issue](https://github.com/greenelab/indices_manuscript/issues) for any question related to licensing.
